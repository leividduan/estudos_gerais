...
{
    public class SubscriptionHandler : Notifiable<Notification>, IHandler<CreateBoletoSubscriptionCommand>, IHandler<CreatePaypalSubscriptionsCommand>
    {
        ...
        public ICommandResult Handle(CreatePaypalSubscriptionsCommand command)
        {
            // //Fail fast validation
            // command.Validate();
            // if(!command.IsValid)
